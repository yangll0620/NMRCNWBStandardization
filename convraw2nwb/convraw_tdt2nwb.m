...
% parse_tdtneuro parses the tdt.streams.Neur tdt sync structure
...
elecinffile = 'elecinf.xlsx';
elec_tbl = readtable(elecinffile);
...
elec_tbl = [elec_tbl elecgroup_ref];
